...
///Autor:DEK
///Fecha:
///Comentario:  ACTUALMENTE SIN USO (FUNCIONES CONVERTIDAS EN METODOS DEL GESTOR)
...
void cargarVectores(Libro *vLibros, Prestamo *vPrestamos, Socio *vSocios) {
    ...
    for (int i = 0; i < 10; i++) {
        ...
        vPrestamos[i].setIdSocio(vSocios[i].getId());     // Toma un ID válido del vector
